...
public class KoreanEnv {
	...
	/**
	 * The props member gets its values from the configuration in the property
	 * file.
	 */
	...
	private void initDefaultProperties() {
		...
		defaults.setProperty(FILE_SYLLABLE_FEATURE,
				"org/apache/lucene/analysis/kr/dic/syllable.dic");
		defaults.setProperty(FILE_DICTIONARY,
				"org/apache/lucene/analysis/kr/dic/dictionary.dic");
		defaults.setProperty(FILE_EXTENSION,
				"org/apache/lucene/analysis/kr/dic/extension.dic");
		defaults.setProperty(FILE_JOSA,
				"org/apache/lucene/analysis/kr/dic/josa.dic");
		defaults.setProperty(FILE_EOMI,
				"org/apache/lucene/analysis/kr/dic/eomi.dic");
		defaults.setProperty(FILE_PREFIX,
				"org/apache/lucene/analysis/kr/dic/prefix.dic");
		defaults.setProperty(FILE_SUFFIX,
				"org/apache/lucene/analysis/kr/dic/suffix.dic");
		defaults.setProperty(FILE_COMPOUNDS,
				"org/apache/lucene/analysis/kr/dic/compounds.dic");
		defaults.setProperty(FILE_UNCOMPOUNDS,
				"org/apache/lucene/analysis/kr/dic/uncompounds.dic");
		defaults.setProperty(FILE_CJ,
				"org/apache/lucene/analysis/kr/dic/cj.dic");
	...
	private Properties loadProperties(Properties def) throws MorphException {
		...
		try {
			...
			throw new MorphException(
					"Failure while trying to load properties file "
							+ FILE_KOREAN_PROPERTY, e);
		}
		return properties;
	}
